...
int main(int argc, char *argv[])
{
    ...
    //create 3D point
    std::vector<double> point1 { nearest_3_neighbors.second[0][0], nearest_3_neighbors.second[0][1], vals[nearest_3_neighbors.first[0]] };
    std::vector<double> point2 { nearest_3_neighbors.second[1][0], nearest_3_neighbors.second[1][1], vals[nearest_3_neighbors.first[1]] };
    std::vector<double> point3 { nearest_3_neighbors.second[2][0], nearest_3_neighbors.second[2][1], vals[nearest_3_neighbors.first[2]] };

    std::cout << "Point 1: " << point1[0] << " " << point1[1] << " " << point1[2] << std::endl;
    std::cout << "Point 2: " << point2[0] << " " << point2[1] << " " << point2[2] << std::endl;
    std::cout << "Point 3: " << point3[0] << " " << point3[1] << " " << point3[2] << std::endl;

    std::cout << "Query Point: " << query_point[0] << " " << query_point[1] << std::endl;

    std::cout << "Interpolated value: " << DataManipulation::lin_interp_2d(point1, point2, point3, query_point) << std::endl;
