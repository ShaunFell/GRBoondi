...
int main(int argc, char *argv[])
{
    ...
    //Here we test the outputs of the background functions
    {
        ...
        //KerrdeSitter
        {
            ...
            std::cout << tab << " kerr cosmo_constant = " << kerr_params.cosmo_constant << std::endl;
            ...
            std::cout << tab << "outer_horizon = " << outer_horizon << std::endl;
            ...
            std::cout << tab << "inner_horizon = " << inner_horizon << std::endl;
