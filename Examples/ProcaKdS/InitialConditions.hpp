...
class Initial_Proca_Conditions
{
    ...
    public:
        Initial_Proca_Conditions(double a_dx, params_t a_params, ProcaField::params_t a_matter_params, KdSParams a_Kerr_params, KerrdeSitter a_background): m_dx{a_dx}, m_params{a_params}, m_matter_params{a_matter_params}, m_Kerr_params{a_Kerr_params}, m_background(a_background) {};
        ...
        void compute(Cell<data_t> current_cell) const
        {
            ...
            data_t gamma_det = TensorAlgebra::compute_determinant_sym(metric_vars.gamma);
            ...
            mattervars.Avec[0] = m_params.init_amplitude * exp(-radius / r0_BL) / gamma_det;
