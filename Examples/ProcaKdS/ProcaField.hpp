...
class ProcaField: public BaseProcaField<KerrdeSitter, ProcaField>
{
    ...
    public:
        ...
        ProcaField(KerrdeSitter a_background, params_t a_params): BaseProcaField<KerrdeSitter, ProcaField>(a_background),  m_background(a_background), m_params(a_params)
        {
        ...
        ) const
        {
            ...
            //Add evolution of auxiliary scalar field
             total_rhs.Z += 2 * metric_vars.lapse * dVdA * matter_vars.phi - m_params.vector_damping * metric_vars.lapse * matter_vars.Z + advec.Z;
            FOR1(i)
            {
