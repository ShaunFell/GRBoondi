...
public:
    ...
    virtual void additionalPostTimeStep() override
    {
        ...
        if (m_time >= m_p.relaxation_time && m_p.evolve_bh &&m_p.activate_extraction && m_level == min_level && at_course_timestep_on_any_level)
        {
            ...
            //Note: This error check is already present in the constructor for the KerrSchild class.
    ...
    virtual void preTagCells() override 
    {
        ...
        if (m_p.activate_gnn_tagging && m_time > m_dt)
        {
            ...
            ExcisionDiagnostics<ProcaField,KerrSchild> excisor(kerr_schild, m_dx, m_p.center, m_p.diagnostic_inner_boundary, m_p.diagnostic_outer_boundary,vars_to_excise);
