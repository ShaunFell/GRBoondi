...
BaseProcaField<background_t, modification_t>::compute_emtensor(
    const vars_t<data_t> &matter_vars, const MetricVars<data_t> &metric_vars,
...
) const
{
    ...
    emtensor_t<data_t> EM_Tensor{
        compute_emtensor(matter_vars, metric_vars, d1, gamma_UU, chris_ULL)};
