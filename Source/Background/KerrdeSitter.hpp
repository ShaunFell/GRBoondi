...
class KerrdeSitter
{
  public:
                                   ...
                                   const Coordinates<data_t> &coords) const
    {
        ...
        //debugging 
  /*       {
            std::cout << "Spherical shift: "<<std::endl;
            FOR1(i)
            {
                std::cout << "spherical_shift[" << i << "] = " << spherical_shift[i] << " ";
            }
            std::cout << std::endl;

            std::cout << "\nSpherical gamma: "<<std::endl;
            FOR1(i)
            {
                FOR1(j)
                {
                    std::cout << "spherical_gamma[" << i << "][" << j << "] = "<<spherical_gamma[i][j] << " ";
                }
                std::cout << std::endl;
            }

            std::cout << "\ndspherical_lapse: "<<std::endl;
            FOR1(i)
            {
                std::cout << "dspherical_lapse[" << i << "] = " << dlapse_dr[i] << " ";
            }
            std::cout << std::endl;

            std::cout << "\ndspherical_shift: "<<std::endl;
            FOR1(i)
            {
                FOR1(j)
                {
                    std::cout << "dspherical_shift[" << i << "][" << j << "] = " << dshift_dr[i][j] << " ";
                }
                std::cout << std::endl;
            }
            
            std::cout << "\ndspherical_gamma: "<<std::endl;
            FOR1(i)
            {
                FOR1(j)
                {
                    FOR1(k)
                    {
                        std::cout << "dspherical_gamma[" << i << "][" << j << "][" << k << "] = " << dgamma_dr[i][j][k] << " ";
                    }
                    std::cout << std::endl;
                }
                std::cout << std::endl;
            ...
            std::cout << "\njacobian_BL_to_Cart: "<<std::endl;
            FOR1(i)
            {
                FOR1(j)
                {
                    std::cout << "jacobian_BL_to_Cart[" << i << "][" << j << "] = " << jacobian_BL_to_Cart[i][j] << " ";
                }
                std::cout << std::endl;
            }

            std::cout << "\njacobian_cart_to_BL: "<<std::endl;
            FOR1(i)
            {
                FOR1(j)
                {
                    std::cout << "jacobian_cart_to_BL[" << i << "][" << j << "] = " << jacobian_Cart_to_BL[i][j] << " ";
                }
                std::cout << std::endl;
            }

            std::cout << "\njacobian_BL_to_Cart_deriv: "<<std::endl;
            FOR1(i)
            {
                FOR1(j)
                {
                    FOR1(k)
                    {
                        std::cout << "jacobian_BL_to_Cart_deriv[" << i << "][" << j << "][" << k << "] = " << jacobian_BL_to_Cart_deriv[i][j][k] << " ";
                    }
                    std::cout << std::endl;
                }
                std::cout << std::endl;
            ...
            std::cout << "\njacobian_cart_to_BL_deriv: "<<std::endl;
            FOR1(i)
            {
                FOR1(j)
                {
                    FOR1(k)
                    {
                        std::cout << "jacobian_cart_to_BL_deriv[" << i << "][" << j << "][" << k << "] = " << jacobian_Cart_to_BL_deriv[i][j][k] << " ";
                    }
                    std::cout << std::endl;
                }
                std::cout << std::endl;
