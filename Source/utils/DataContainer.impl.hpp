...
DataContainer<data_type>::DataContainer(
    std::vector<std::vector<data_type>> a_matrix_data)
{
...
template <class data_type>
std::pair<std::vector<data_type>, data_type> &
DataContainer<data_type>::get_inx(int inx)
{
    return m_spatial_data[inx];
}

template <class data_type> int DataContainer<data_type>::size() const
{
    return m_current_size;
}

template <class data_type>
void DataContainer<data_type>::add_data(std::vector<data_type> coord,
...
template <class data_type>
std::vector<std::vector<data_type>>
DataContainer<data_type>::get_columns(int min_inx, int max_inx)
{
