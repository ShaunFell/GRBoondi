...
class TimeDataContainer
{
    ...
    public:
        ...
        TimeDataContainer(): m_current_size{0}, m_data_history{} {}; //default constructor

        //constructor to initialize container with a single data point
        TimeDataContainer(data_type time, std::vector<data_type> data): m_current_size{1}, m_data_history{{time, data}} {}; 
...
/*
This class stores generic N-dimensional scalar data, in the form of coordinate-value pairs
This is a value container that stores the values explicitly and doesnt allocate new memory space
*/
template <typename data_type>
class DataContainer
{
    private:
        //vector of pairs, first member is the coordinate location and the second the scalar data
    ...
    public:
        DataContainer(): m_current_size{0}, m_spatial_data{} {}; //default constructor

        //constructor to initialize container with an NxM matrix, assuming the last column
        // is the value data
