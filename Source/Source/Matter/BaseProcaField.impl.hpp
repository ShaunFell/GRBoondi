...
emtensor_t<data_t> ProcaField<higherterms_t, background_t>::compute_emtensor(
...
template <class higherterms_t>
template <class data_t, template <typename> class vars_t,
          template <typename> class diff2_vars_t,
          template <typename> class rhs_vars_t>
void ProcaField<higherterms_t>::matter_rhs(
...
) const
{
    ...
    total_rhs.Z =  - m_params.vector_damping * metric_vars.lapse * matter_vars.Z + advec.Z;
    FOR1(i)
    {
