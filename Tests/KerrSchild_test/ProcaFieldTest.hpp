#ifndef PROCAFIELDTEST_H_INCLUDED
#define PROCAFIELDTEST_H_INCLUDED
...
// template argument
class ProcaFieldTest : public BaseProcaFieldTest<KerrSchild, ProcaFieldTest>
{
  ...
  public:
    ...
    ProcaFieldTest(KerrSchild a_background, params_t a_params)
        : BaseProcaFieldTest<KerrSchild, ProcaFieldTest>(a_background),
...
#endif // PROCAFIELDTEST_H_INCLUDED