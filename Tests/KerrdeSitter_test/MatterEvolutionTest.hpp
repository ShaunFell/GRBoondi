...
template <class matter_t, class background_t> class MatterEvolution
{
  public:
    ...
    // Vars for constraint calculations
    template <class data_t> struct ConstraintVars
    {
        data_t Ham;
        Tensor<1, data_t> Mom;
    ...
    template <class data_t> void compute(Cell<data_t> current_cell) const
    {
        ...
        ConstraintVars.Ham = EulerEnergy;
        ConstraintVars.Mom = {0.0, 0.0, 0.0};

        current_cell.store_vars(ConstraintVars);
