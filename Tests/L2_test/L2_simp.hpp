...
/*
This file calculates to the modifications to the equations of motion and energy
momentum tensor coming from the second generalized Proca lagrangian
...
we simplify things. Since we add virtual functions to the ProcaField class which
can account for arbitrary modifications to the field equations and energy
momentum tensor, the user can freely specify any modifications they want.

NOTE: This assumes the theory is L = -1/4 F^2 + alpha2 * L_2 with no other
modifications due to higher lagrangians
*/
