...
int test2()
{
    ...
    for (int ires{0}; ires < num_resolutions; ++ires)
    {
        ...
        // create background
        typename BoostedBH::params_t bg_params;
        ...
        std::cout << "Center: " << bg_params.center[0] << " "
                  ...
                  << std::endl;
        BoostedBH background_init(bg_params, dx);
        ...
        MatterEvolution<ProcaField, BoostedBH> my_an_evolution(
...
int main(int argc, char *argv[])
{
    ...
    std::cout << std::string(10, '#') << std::endl;
    std::cout << std::string(10, '#') << std::endl;
    std::cout << "current tests: BoostedBH Extended Test" << std::endl;
    std::cout << std::string(10, '#') << std::endl;
    std::cout << std::string(10, '#') << std::endl;
    int test2res = test2();
